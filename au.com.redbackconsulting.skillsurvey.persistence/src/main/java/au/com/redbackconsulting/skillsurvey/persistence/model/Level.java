...
public class Level implements Serializable, IDBEntity {
	...
	public static Comparator<Level> LevelNameComparator 
    = new Comparator<Level>() {

public int compare(Level level1, Level level2) {

String levelName1 = level1.getDescription().toUpperCase();
String levelName2 = level2.getDescription().toUpperCase();
