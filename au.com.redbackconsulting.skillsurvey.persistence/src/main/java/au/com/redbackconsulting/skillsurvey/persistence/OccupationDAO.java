...
public class OccupationDAO extends BasicDAO<Occupation>  {
	...
	public Occupation getReferenceById(long id){
		
		EntityManager em = super.emProvider.get();
		Occupation refOoccupation =em.getReference(Occupation.class, id);
		return refOoccupation;
	}
}
