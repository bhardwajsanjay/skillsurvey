...
//		
			...
			Need needEntity = needDAo.getById(Long.parseLong(need));
			
			PathwayDAO pathwayDAO = new PathwayDAO();
			Pathway pathwayEntity = pathwayDAO.getById(Long.parseLong(pathway));
	        ...
	        try {
	        	//TODO 
			if(needEntity!=null && pathwayEntity!=null){
				entity.setNotes(notes);
				entity.setNeed(needEntity);
				entity.setPathway(pathwayEntity);
				//entity.setUocs(uocs);
...
@Consumes(MediaType.APPLICATION_JSON  )	
   public Response addNew(@FormParam("notes") String notes,
	...
	return createBadRequestResponse("Need or Pathway not found");
   }
