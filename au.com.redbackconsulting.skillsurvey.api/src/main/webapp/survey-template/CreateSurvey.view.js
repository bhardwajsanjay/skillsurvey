sap.ui.jsview("survey-template.CreateSurvey", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf survey-template.CreateSurvey
	*/ 
	getControllerName : function() {
		return "survey-template.CreateSurvey";
	},
...
//			id : "id", // sap.ui.core.ID
			...
			wrapping : false, // boolean
			width : '', // sap.ui.core.CSSSize
			text : '{createsurveymodel>sno}', // string
			visible : true, // boolean, since 1.14.0
...
//			id : "id", // sap.ui.core.ID
			text : '{createsurveymodel>label}', // string
		...
		//		id : "id1", // sap.ui.core.ID
				key : 'key', // string
				value : '{createsurveymodel>key}', // any
				writeToDom : false, // boolean, since 1.9.0
				tooltip : undefined, // sap.ui.core.TooltipBase
				customData : []
			// sap.ui.core.CustomData
...
//				id : "id1", // sap.ui.core.ID
			...
			content : {path : "createsurveymodel>/Items", template : oHorizontal}
		// sap.ui.core.Control
		});
