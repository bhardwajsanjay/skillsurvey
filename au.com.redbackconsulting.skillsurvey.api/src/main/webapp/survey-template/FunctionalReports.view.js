sap.ui.jsview("survey-template.FunctionalReports", {
	...
	*/ 
	getControllerName : function() {
		return "survey-template.FunctionalReports";
	},
	...
	*/ 
	createContent : function(oController) {
			...
			var oTileTmp = new sap.m.StandardTile({
				//id:"{id}",
				icon : "{icon}",
				title : "{FunctionalReportsModel>label}",
				info : "{FunctionalReportsModel>label}",
				press:function(evt){
					oController.handleTilesPress(evt.getSource().getBindingContext("FunctionalReportsModel").getObject());
			...
			oTileCont.bindAggregation("tiles","FunctionalReportsModel>/",oTileTmp);
