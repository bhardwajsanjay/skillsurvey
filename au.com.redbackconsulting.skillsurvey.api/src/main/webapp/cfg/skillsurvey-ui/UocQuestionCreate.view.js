sap.ui.jsview("skillsurvey-ui.UocQuestionCreate", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf skillsurvey-ui.UocQuestionCreate
	*/ 
	getControllerName : function() {
		return "skillsurvey-ui.UocQuestionCreate";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		var oLabel =  new sap.m.Label({ text : "Uoc Id"	});
		...
		oLabel = new sap.m.Label({	text : "Question ID :"	});
		var oItemSelectTemplate = new sap.ui.core.Item({
	           key:"{id}",
	           text : "{text}"
	        });     
	    ...
	    var oSelect = new sap.m.Select({
	        	...
	        	visible: true,
	        	enabled: true,
	        	selectedKey :'{transientModel>/questionId}',
	         });
	    //var mm = sap.ui.getCore().getModel("needModel").oData;
	  
	    oSelect.setModel(sap.ui.getCore().getModel("QuestionModel"));
	    oSelect.bindAggregation("items", "/", oItemSelectTemplate);
