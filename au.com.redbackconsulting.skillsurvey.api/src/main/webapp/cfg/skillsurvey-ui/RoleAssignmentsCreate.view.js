sap.ui.jsview("skillsurvey-ui.RoleAssignmentsCreate", {
	...
	*/ 
	getControllerName : function() {
		return "skillsurvey-ui.RoleAssignmentsCreate";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		var oLabel =  new sap.m.Label({ text : "Individual Id"	});     
		 ...
		 var oItemSelectTemplateRole = new sap.ui.core.Item({
	           key:'{id}',
	           text : "{name}"
	        });     

	    var oSelectRole = new sap.m.Select({
	    ...
	    oSelectRole.setModel(sap.ui.getCore().getModel("IndividualModel"));
	    oSelectRole.bindAggregation("items", "/", oItemSelectTemplateRole);
	    
		oLayout.addContent(oLabel, {left : "20px",	top : "25px"});
		oLayout.addContent(oSelectRole, {left : "200px",	top : "15px"});
    ...
    var oItemSelectTemplateRole = new sap.ui.core.Item({
	    ...
	    oSelectRole.setModel(sap.ui.getCore().getModel("RoleModel"));
	    oSelectRole.bindAggregation("items", "/", oItemSelectTemplateRole);
		
		oLayout.addContent(oLabel, {left : "20px", top : "70px" 	});
		oLayout.addContent(oSelectRole, {left : "200px",	top : "60px"
		});
