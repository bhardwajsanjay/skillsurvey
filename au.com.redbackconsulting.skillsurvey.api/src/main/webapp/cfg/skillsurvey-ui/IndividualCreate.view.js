sap.ui.jsview("skillsurvey-ui.IndividualCreate", {
	...
	*/ 
	getControllerName : function() {
		return "skillsurvey-ui.IndividualCreate";
	},
	...
	*/ 
	createContent : function(oController) {
	    ...
	    var oSelect = new sap.m.Select({
	        	...
	        	visible: true,
	        	enabled: true,
	        	selectedKey :'{transientModel>/departmentId}',
	         });
...
//	        });     
	    ...
	    oSelect2.bindAggregation("items", "/", oItemSelectTemplate);
