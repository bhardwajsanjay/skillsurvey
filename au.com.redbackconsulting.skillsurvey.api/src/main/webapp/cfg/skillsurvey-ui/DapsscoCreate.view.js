sap.ui.jsview("skillsurvey-ui.DapsscoCreate", {
	...
	*/ 
	getControllerName : function() {
		return "skillsurvey-ui.DapsscoCreate";
	},
	...
	*/ 
	createContent : function(oController) {
	    ...
	    var oSelect = new sap.m.Select({
	        	...
	        	visible: true,
	        	enabled: true,
	        	selectedKey :'{transientModel>/OccupationName}',
	         });
	    ...
	    oSelect1.setModel(sap.ui.getCore().getModel("LevelModel"));
