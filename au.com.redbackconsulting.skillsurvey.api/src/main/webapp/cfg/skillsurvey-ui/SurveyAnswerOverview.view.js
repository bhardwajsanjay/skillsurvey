sap.ui.jsview("skillsurvey-ui.SurveyAnswerOverview", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf skillsurvey-ui.SurveyAnswerOverview
	*/ 
	getControllerName : function() {
		return "skillsurvey-ui.SurveyAnswerOverview";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		var oLabel =  new sap.m.Label({ text : "UOC Question ID :"	});
		...
		var oNameInput =new sap.m.Input({
			...
			editable:false,
				value:{
					path : 'transientModel>/uoc_QuestionId',
		...
		oLabel = new sap.m.Label({	text : "value :"	});
		oNameInput =new sap.m.Input({
			editable:false,
			width:"250px",
