sap.ui.jsview("skillsurvey-ui.SupervisonsOverview", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf skillsurvey-ui.SupervisonsOverview
	*/ 
	getControllerName : function() {
		return "skillsurvey-ui.SupervisonsOverview";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		var oNameInput =new sap.m.Input({
			...
			editable:false,
				value:{
					path : 'transientModel>/supervisorId',
		...
		oLabel = new sap.m.Label({	text : "Supervised ID :"	});
		oNameInput =new sap.m.Input({
			...
			placeholder:"Enter description",
				value:{
					path : 'transientModel>/supervisedId',
					constraints : {
						minLength: 1,
						maxLength: 100
					}
