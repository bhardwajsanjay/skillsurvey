...
//	}
	...
	handleOverview:function(evt){
		...
		bus.publish("nav","toOverview",{id : "ClaimOverview", tableid :"Claim"	});
	},
	...
	handleCreate:function(evt){
		var bus = sap.ui.getCore().getEventBus();
		bus.publish("nav","toCreate",{id : "ClaimCreate", tableid :"Claim"	});
	},
	...
	sap.m.MessageBox.confirm(
				...
				function (oAction) {
					if (sap.m.MessageBox.Action.OK === oAction) {
						var bus = sap.ui.getCore().getEventBus();
						bus.publish("nav","toDelete",{id : "Claim", tableid :"Claim"});
					}
				}
		);
